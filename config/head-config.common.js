...
module.exports = {
  link: [
    ...
    { rel: 'icon', type: 'image/png', sizes: '192x192', href: '/assets/icon/cuppa-favicon16x16.png' },

    /** <link> tags for favicons **/
    { rel: 'icon', type: 'image/png', sizes: '32x32', href: '/assets/icon/cuppa-favicon32x32.png' },
    { rel: 'icon', type: 'image/png', sizes: '96x96', href: '/assets/icon/cuppa-favicon96x96.png' },
    { rel: 'icon', type: 'image/png', sizes: '16x16', href: '/assets/icon/cuppa-favicon16x16.png' },
